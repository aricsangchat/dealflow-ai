    ...
    return (
      <main className="min-h-screen bg-slate-950 p-10 text-white">
        ...
        <p className="mt-2 text-slate-400">
          Trigger a market refresh to populate this dashboard.
        </p>
        <div className="mt-6">
          <RefreshMarketButton marketKey={marketKey} />
        </div>
      </main>
    );
  }
      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-64 border-r border-slate-800 bg-slate-900 lg:block">
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-slate-400">{marketKey}</p>
          </div>
          ...
          <div className="p-6">
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
              <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
                <div className="text-sm text-slate-400">Avg Investment Score</div>
                <div className="mt-2 text-3xl font-semibold">{avgScore.toFixed(1)}</div>
              </div>

              <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
                <div className="text-sm text-slate-400">Avg Cap Rate</div>
                <div className="mt-2 text-3xl font-semibold">{avgCapRate.toFixed(1)}%</div>
              </div>

              <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
                <div className="text-sm text-slate-400">Best Cash Flow</div>
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
                ...
                <div className="mt-2 text-3xl font-semibold">{deals.length}</div>
              </div>
            </div>
